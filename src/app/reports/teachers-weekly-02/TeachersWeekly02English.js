...
export default function TeachersWeekly02English() {
    const handlePrint = () => {
        window.print();
    };
    ...
    return (
        <div className="teachers-report" dir="ltr">
            ...
            <div className="report-header">
                ...
                <span className="week-badge">📅 Week 2: {weeklyData.dateRange.en}</span>
            </div>
                                        ...
                                        <div className="screenshot-gallery">
                                            <div className="screenshot-item">
                                                <div style={{ padding: '2rem', textAlign: 'center', color: '#666', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '8px', background: 'rgba(0,0,0,0.2)' }}>
                                                    {teacher.evidenceType === 'video' ? '🎬 VIDEO' : '🖼️ IMAGE'}
                                                </div>
                                                <div className="screenshot-caption">
                                                    {teacher.evidenceType === 'video' ? 'Video Evidence' : 'Image Evidence'}
                                                </div>
                                            </div>
                                        </div>
                                    </>
